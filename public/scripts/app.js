...
var Person = function () {
  function Person() {
    ...
    // the equals pertains to default values
    this.name = name;
    this.age = age;
  }
...
var me = new Student('Ashwin Nishad', 20, 'CS');
...
var jane = new Traveler('Jane Plaza', 25, 'Seattle');
console.log(jane.getGreeting());

var mark = new Traveler('Mark Weins', 28);
